						...
						>
							<div className='flex flex-col gap-3 lg:gap-11'>
								...
								<Select onChange={val => console.log('Выбрано:', val)}>
									<SelectOption value='Wymiana i wyważanie kół'>
										Wymiana i wyważanie kół
									</SelectOption>
									<SelectOption value='Wymiana oleju'>
										Wymiana oleju
									</SelectOption>
									<SelectOption value='Serwis klimatyzacji'>
										Serwis klimatyzacji
									</SelectOption>
									<SelectOption value='Sezonowa wymiana opon'>
										Sezonowa wymiana opon
									</SelectOption>
									<SelectOption value='Przechowywanie kół w naszym magazynie'>
						...
						>
							<div className='flex flex-col flex-shrink-0 md:flex-row gap-9 lg:gap-12'>
								<DayPicker
									...
									modifiersStyles={{
										available: { backgroundColor: '#4CAF50', color: 'white' },
									}}
								...
								{selectedDate && (
									<div className='mt-4'>
										<h3>Свободные слоты на {selectedDate.toDateString()}:</h3>
										<ul className='flex flex-wrap'>
											{availableSlots.length > 0 ? (
												availableSlots.map((slot, index) => (
													<li key={index} className=' p-2 rounded-lg mt-2'>
