...
-- AddForeignKey
ALTER TABLE "ServiceReservation" ADD CONSTRAINT "ServiceReservation_reservationId_fkey" FOREIGN KEY ("reservationId") REFERENCES "Reservation"("id") ON DELETE CASCADE ON UPDATE CASCADE;
